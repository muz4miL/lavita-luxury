...
export default function HeroVideoParallax() {
  ...
  useEffect(() => {
    ...
    // Smooth fade in on load (desktop only)
    if (!isMobile && video) {
      gsap.fromTo(video,
        { opacity: 0 },
  ...
  return (
    <section
      ref={sectionRef}
      className={`relative ${isMobile ? 'h-auto min-h-screen flex flex-col' : 'h-screen w-full overflow-hidden'} bg-gradient-to-br from-[#0B1C19] via-[#0A1613] to-[#050F0D] text-white`}
    >
      {/* ==================== MOBILE LAYOUT ==================== */}
      {isMobile ? (
        <>
          ...
          <div className="flex-1 bg-gradient-to-b from-[#0B1C19] to-[#050F0D] flex flex-col justify-center items-center px-6 py-10">
            <div className="w-full max-w-md text-center">
              ...
              <h1 className="mb-6 font-serif text-4xl font-medium leading-tight text-white">
                ...
                <span className="block text-[#D4AF37] italic text-3xl">
                  In The Clouds
                </span>
              </h1>
              ...
              {/* Gold Divider */}
              <div className="h-[1px] w-24 bg-gradient-to-r from-[#D4AF37] to-[#D4AF37]/60 mx-auto my-6" />

              {/* "A VISION OF" */}
              <div className="mb-4">
                <span className="text-xs tracking-[0.25em] text-white/70 font-sans uppercase font-light">
                  A VISION OF
                </span>
              </div>
              ...
              {/* Main Headline */}
              <div className="mb-6">
                <h2 className="text-3xl italic text-[#D4AF37] font-light font-serif mb-2">
                  Timeless
                </h2>
                <h2 className="text-3xl text-white font-light font-serif">
                  Elegance
                </h2>
              </div>

              {/* Description */}
              <p className="text-white/85 font-light leading-relaxed mb-6">
              ...
              <div className="flex items-center justify-center gap-4 group cursor-pointer">
                ...
                <span className="text-[10px] tracking-[0.35em] text-white/50 uppercase font-sans font-light">
                  EXPLORE BELOW
                </span>
        ...
        <>
          ...
          <div
            ...
            className="absolute z-20 overflow-hidden bg-black/20 w-full h-full right-0 top-0 rounded-none shadow-none"
          >
          ...
          <div
            ref={anchorLineRef}
            className="absolute left-1/2 top-1/2 z-20 h-0 w-[1px] -translate-x-1/2 -translate-y-1/2 bg-gradient-to-b from-transparent via-[#D4AF37]/20 to-transparent opacity-0"
          />
